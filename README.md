...
This course uses [Julia](https://julialang.org), a fast, modern programming language well suited for scientific computing, and [Pluto](https://plutojl.org), a reactive notebook environment for Julia that makes it easy to explore and visualize physics concepts interactively. See the [Pluto install guide](https://plutojl.org/#install) for detailed setup instructions.
